...
Public Class ClassSolicitudValidacion
    ...
    Public Function ValidarSprint3(dto As SolicitudFormularioDto) As List(Of String)
        Dim errores As New List(Of String)()

        If Not dto.AceptaDeclaracion Then
            errores.Add("Debe aceptar la declaracion legal.")
        End If

        If String.IsNullOrWhiteSpace(dto.FirmaSolicitante) Then
            errores.Add("Ingrese firma del solicitante.")
        End If

        If String.IsNullOrWhiteSpace(dto.FirmaPatrono) Then
            errores.Add("Ingrese firma del patrono/contratante.")
        End If

        If String.IsNullOrWhiteSpace(dto.FechaFirma) Then
            errores.Add("Ingrese fecha de firma.")
        End If
